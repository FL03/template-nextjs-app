...
export const flavorVariants = cva("", {
  ...
  variants: {
    flavor: {
      ...
      primary: "bg-primary test-primary-foreground border-primary/15",
      secondary: "bg-secondary test-secondary-foreground border-secondary/15",
      destructive:
        "bg-destructive test-destructive-foreground border-destructive/15",
    },
  },
});
