...
export type WithoutBody<TData extends RequestInit> = Omit<
  TData,
  "body"
>;

export type WithoutMethod<TData extends RequestInit> = Omit<
  TData,
  "method"
>;
...
export type WithDataOrError<TData = unknown> = { data: TData; error?: null } | {
  data: null;
  error: Error;
};
