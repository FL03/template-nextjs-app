...
export async function GET(req: NextRequest): Promise<ApiResponse<ShiftData[]>> {
  ...
  if (sortBy) {
    ...
    query = query.order(key as keyof ShiftData, { ascending: value === 'asc' });
  }
