...
import { ClientHandler as FetchHandler } from '@/types/handlers';
// feature-specific
 ...
 */
export const fetchNotifications: FetchHandler<
...
> = async (params, init) => {
  ...
  const url = new URL(NOTIFICATIONS_ENDPOINT, resolveOrigin());
