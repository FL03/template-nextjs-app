...
Scattered-Systems, LLC Terms of Use  
Oct 31, 2025  
   
Welcome to the Scattered-Systems, LLC Terms of Use agreement. For purposes of this agreement, “Site” refers to the Company’s website, which can be accessed at https://scsys.io. “Service” refers to the Company’s services accessed via the Site, in which users can orchestrate next generation virtual workspaces. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our Site or our Service. 

The following Terms of Use apply when you view or use the Service via our website located at https://scsys.io or by accessing any of our applications or services at their hosted namespaces.  
...
The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (found here: https://scsys.io/privacy) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.

## **ABOUT THE SERVICE**

The Service allows you to maintain a personal ledger of your earned tips .  
...
When you create your own personalized account, you may be able to provide your name, a unique username, email addresses, phone numbers,billing information (handled by stripe) and other personal attributes that may be used to customize the user-profile (“User Content”) to the Service. You are solely responsible for the User Content that you post, upload, link to or otherwise make available via the Service.   
...
We may also use your email address to send you other messages, including information about the Site or the Service and special offers. You may opt out of such email by changing your account settings, using the “Unsubscribe” link in the message, or by sending an email to support@scsys.io or mail to the following postal address:  
...
YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY AT [https://scsys.io/privacy](https://scsys.io/privacy) REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.
